...
export const getters = {
    //getPackageId is a method. This method returns a function. and this fn returns the information we want.
    //id is our payload. We're gonna provide it.
    getPackageId: (state) => (id) => {
...
export const mutations= {
    addTrip(state, id) {
      let bookedPack = state.packages.find(pack => pack.id == id)
      state.myTrips.push(bookedPack)
    }
}